...
title @a subtitle {"text":"You need to run function mxpassive initialise first time.","color":"gold"}
...
execute if score mxgsb glinstalled matches 0 run function mxpassive:initialise
